...
def show_warning():
    ...
    messagebox = tk.messagebox.showwarning("Alerta", "Se detectaron cambios bruscos en la pantalla.")
    root.destroy()
...
while True:
    ...
    for row in range(num_rows):
        for col in range(num_cols):
            ...
            cell_array = np.array(cell_img)  # Mover la definición de cell_array aquí
    ...
    # Verificar si hay cambios bruscos
